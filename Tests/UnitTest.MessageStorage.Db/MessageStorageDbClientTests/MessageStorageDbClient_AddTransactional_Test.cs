...
{
    public class MessageStorageDbClient_AddTransactional_Test
    {
        ...
        {
            (Message message, IEnumerable<Job> jobs) = _sut.Add(null as string, _dbTransactionMock.Object);
        ...
        {
            (Message message, IEnumerable<Job> jobs) = _sut.Add(null as string, _dbTransactionMock.Object, autoJobCreator: false);
            ...
            _dbMessageRepositoryMock.Verify(repository => repository.Add(It.IsAny<Message>(), It.IsAny<IDbTransaction>()), Times.Once);
            _dbJobRepositoryMock.Verify(repository => repository.Add(It.IsAny<Job>(), It.IsAny<IDbTransaction>()), Times.Never);
        ...
        public void WhenCompatibleHandlerExist__XNumberOfJobCreated()
        {
            ...
            _dbMessageRepositoryMock.Verify(repository => repository.Add(It.IsAny<Message>(), It.IsAny<IDbTransaction>()), Times.Once);
            _dbJobRepositoryMock.Verify(repository => repository.Add(It.IsAny<Job>(), It.IsAny<IDbTransaction>()), Times.Exactly(handlerNames.Count));
        }
    }
}