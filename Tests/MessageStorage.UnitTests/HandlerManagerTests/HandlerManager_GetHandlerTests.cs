...
namespace MessageStorage.UnitTests.HandlerManagerTests
{
    public class HandlerManager_GetHandlerTests
    {
        ...
        [Test, Sequential]
        public void WhenHandlerNameIsNullOrEmpty__HandlerNotFoundExceptionOccurs([Values("", arg2: null)] string handlerName)
        {
            Assert.Throws<HandlerNameIsEmptyException>(() => _sut.GetHandler(handlerName));
        }
