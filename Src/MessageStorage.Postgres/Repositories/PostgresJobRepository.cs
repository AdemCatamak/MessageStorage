...
namespace MessageStorage.Postgres.Repositories
{
    internal class PostgresJobRepository : IJobRepository
    {
        ...
        public PostgresJobRepository(IPostgresRepositoryFactory creator, IPostgresMessageStorageTransaction? transaction = null)
        {
            _creator = creator;
...
";
            using IPostgresMessageStorageConnection connection = _creator.CreateConnection();
